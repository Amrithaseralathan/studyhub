<%-- 
    Document   : viewquery
    Created on : 10 Jan, 2023, 6:35:44 PM
    Author     : ARUN
--%>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image/viewquery.jpg" height="400" class="d-block w-100" alt="...">
        ...
        <div class="container">
            ...
            <tr>
               ...
               <td><c:out value = "${row.student}"/></td>
                ...
                <td><form action="response" method="post"><button name="b1" class="btn btn-outline-success" value="${row.student}">Give solution</button><br></form></td>
